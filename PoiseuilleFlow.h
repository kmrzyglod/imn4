...
public:
    PoiseuilleFlow(int xsize, int ysize, double dx, double dy, FlagMatrix* flagMatrix,  function < double( double x, double y) > boundaryConditionFnStream,  function <double( double x, double y)> boundaryConditionFnVorticity)
